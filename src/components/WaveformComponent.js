...
class Waveform extends Component {  
  ...
  render() {
    ...
    <span>
    <button className='skip-btns' onClick={this.skipBackward}>
    ...
    <button className='skip-btns' onClick={this.skipForward}><svg data-v-4592c488="" width="19px" height="20px" viewBox="0 0 19 20" version="1.1" xmlns="http://www.w3.org/2000/svg" >
